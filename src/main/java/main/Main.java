...
public class Main {
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        System.out.println("************* WELCOME, BIENVENUE DANS NOTRE APPLICATION DE COMPREHENSION DE LOGICIELS :) ");
    ...
    public static void printMenu(Processor processor) throws IOException, URISyntaxException {
        ...
        switch (parseInt(reader1.readLine())) {
            ...
            case 4:
                ...
                System.out.println(processor.displayIdentificationModules(Double.parseDouble(cp)));
                printMenu(processor);
                break;
            case 0:
                System.exit(0);
